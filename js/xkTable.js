window.onload = () => {
    console.log("加载选课表格Plus");
    // console.log("原函数", queryKxkcList);


    function queryKxkcListPlus() {
        ...
        $("#dataView").dataTable({
            ...
            "aoColumns": [
                ...
                { "mDataProp": "ktmc", "sTitle": "优选班级", "sWidth": "80px", sClass: "center" },
                { "mDataProp": "kcsxmc", "sTitle": "类型", "sWidth": "80px", sClass: "center" },
                { "mDataProp": "kcxzmc", "sTitle": "课程模块", "sWidth": "80px", sClass: "center" }
    ...
    const myTableHeader = document.querySelector('.myTable-header');
    if (myTableHeader?.children[1]?.id == 'xkgzButton') {
        const btn = document.createElement('button');
        btn.id = 'xkgzButtonPlus';
        btn.className = 'layui-btn'
        btn.innerHTML = 'OUC Plus超级查询';
        btn.onclick = queryKxkcListPlus
        myTableHeader.appendChild(btn);
    }
}